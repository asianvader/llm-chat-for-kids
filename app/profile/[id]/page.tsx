...
function RobyMarkdown({ content }: { content: string }) {
  return (
    <div className="roby-markdown [&_p]:my-2 [&_p:first-child]:mt-0 [&_p:last-child]:mb-0 [&_h1]:mb-3 [&_h1]:mt-4 [&_h1]:text-2xl [&_h1]:font-black [&_h2]:mb-2 [&_h2]:mt-4 [&_h2]:text-xl [&_h2]:font-black [&_h3]:mb-2 [&_h3]:mt-3 [&_h3]:font-extrabold [&_ul]:my-2 [&_ul]:list-disc [&_ul]:space-y-1 [&_ul]:pl-5 [&_ol]:my-2 [&_ol]:list-decimal [&_ol]:space-y-1 [&_ol]:pl-5 [&_blockquote]:my-3 [&_blockquote]:border-l-4 [&_blockquote]:border-[#ffc857] [&_blockquote]:pl-3 [&_blockquote]:italic [&_pre]:my-3 [&_pre]:overflow-x-auto [&_pre]:rounded-xl [&_pre]:bg-[#24314d] [&_pre]:p-3 [&_pre]:text-sm [&_pre]:text-white [&_code]:rounded [&_code]:bg-[#eaf3f8] [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:font-mono [&_code]:text-sm [&_pre_code]:bg-transparent [&_pre_code]:p-0 [&_table]:my-3 [&_table]:w-full [&_table]:border-collapse [&_th]:border [&_th]:border-[#c8ddec] [&_th]:bg-[#edf5fb] [&_th]:p-2 [&_th]:text-left [&_td]:border [&_td]:border-[#c8ddec] [&_td]:p-2">
      <ReactMarkdown
        remarkPlugins={[remarkGfm]}
        components={{
          a: ({ href, children }) => (
            <a href={href} target="_blank" rel="noreferrer" className="font-extrabold text-[#267ab8] underline decoration-2 underline-offset-2 hover:text-[#175b8d]">
              {children}
            </a>
          ),
        }}
